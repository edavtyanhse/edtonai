      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-4">
        <div className="max-w-md w-full bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-300 dark:border-slate-700 text-center space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            We sent a verification link to <span className="text-slate-900 dark:text-white font-medium">{email}</span>.
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-4">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-300 dark:border-slate-700">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400">Start creating better resumes today</p>
        </div>
