...
COMMON = {"python","sql","pandas","react","fastapi","ml","product","metrics","a/b","testing","jira","figma"}
...
def ats_score(resume_text: str, vacancy_text: str) -> float:
    ...
    structure = sum(1 for h in ["опыт","experience","skills","навыки","projects","контакты","education","образование"] if h in resume_text.lower())/8
