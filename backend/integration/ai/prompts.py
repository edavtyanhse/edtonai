...
- Определи язык ТЕКСТА РЕЗЮМЕ (не вакансии!).
- Сопроводительное письмо ОБЯЗАНО быть на ТОМ ЖЕ ЯЗЫКЕ, что и резюме.
- Если резюме на English → пиши cover letter на English.
- Если резюме на русском → пиши сопроводительное на русском.
